...
class System(object):
    def __init__(self, sys_name, num_dims,
                 plant_config_dict, delta_t, path, plant_pvt_init_data,
                 min_smt_sample_dist, pi_grid_eps):
...
class Property(object):
    def __init__(self, T, init_cons_list, init_cons, final_cons, pi,
                 initial_discrete_state, MAX_ITER,
                 num_segments, ROI):
        self.T = T
...
#             sut.pi_grid_eps = None
    ...
    sys = System(sys_name, num_dims, plant_config_dict,
                 delta_t, path, plant_pvt_init_data,
                 min_smt_sample_dist, pi_grid_eps)
    prop = Property(T, init_cons_list, init_cons, final_cons,
                    pi, initial_discrete_state,
