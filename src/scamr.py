...
def falsify(sys, prop, current_abs):
    ...
    ci_ref = wmanager.WMap(ci, sys.ci_grid_eps)
    ...
    falsify_using_model(*args, sys_sim=None, sys=sys, prop=prop)
...
#    argcomplete.autocomplete(parser)
    ...
    globalopts.debug_plot = args.enable_regression_plots
    ...
    # matplotlib.
    globalopts.plot = args.plot is not None
